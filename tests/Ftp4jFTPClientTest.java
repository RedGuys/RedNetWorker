...
public class Ftp4jFTPClientTest {
    public static void main(String[] args) throws Exception {
        ...
        ftp4jFTPClient.downloadFile("downloaded.zip","/100MB.zip");
        if(new File("downloaded.zip").length() == 104857600L)  {
        ...
        ftp4jFTPClient.uploadFile("downloaded.zip","downloaded.zip");
